...
public class Const {
	...
	public static final String APP_ID = ConfigUtil.getProperty(PUBLICS_CONF, "appId");

	public static final String APP_SECRET = ConfigUtil.getProperty(PUBLICS_CONF, "appSecret");

	public static final String TOKEN = ConfigUtil.getProperty(PUBLICS_CONF, "token");
