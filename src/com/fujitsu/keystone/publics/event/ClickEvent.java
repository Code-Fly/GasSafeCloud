...
public class ClickEvent extends Event {
    ...
    public String execute(HttpServletRequest request, JSONObject requestJson) {
        ...
        if (eventKey.equals(MenuService.GL_CZCC)) {
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.FILLING_STORAGE + Query.SEPARATOR + Query.QUERY_DETAIL + Query.SEPARATOR + "无锡华润燃气有限公司").append(ENTER);
            buffer.append(ENTER);
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.FILLING_STORAGE + Query.SEPARATOR + Query.QUERY_LIST + Query.SEPARATOR + "华润").append(ENTER);
        ...
        // 配送运输
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.DISTRIBUTION_TRANSPORTATION + Query.SEPARATOR + Query.QUERY_DETAIL + Query.SEPARATOR + "无锡华润燃气有限公司").append(ENTER);
            buffer.append(ENTER);
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.DISTRIBUTION_TRANSPORTATION + Query.SEPARATOR + Query.QUERY_LIST + Query.SEPARATOR + "华润").append(ENTER);
        ...
        // 检验检测
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.INSPECTION_TESTING + Query.SEPARATOR + Query.QUERY_DETAIL + Query.SEPARATOR + "无锡华润燃气有限公司").append(ENTER);
            buffer.append(ENTER);
            ...
            buffer.append("例:").append(ENTER);
            buffer.append(Query.SEPARATOR + Query.INSPECTION_TESTING + Query.SEPARATOR + Query.QUERY_LIST + Query.SEPARATOR + "华润").append(ENTER);
